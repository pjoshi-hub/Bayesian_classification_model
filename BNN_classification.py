...
df_pca2 = pd.read_csv('103_genes_pca2_new.csv')
...
clf_log = LogisticRegression(penalty='l2',solver='lbfgs').fit(X_train_combined,y_train_combined)
...
#df_temp.to_csv('paper_tables/bnn_results.csv')
...
#df_confusion_normalized.to_csv('Source_data/1C.csv')
...
df_temp['fscore'] = list(fscore)
df_temp['support'] = list(support)
#df_temp.to_csv('paper_tables/bnn_results_method1.csv')
...
#df_temp.to_csv('paper_tables/detailed_uncertainty_epistemic.csv')
...
df_temp['test_mean_correct'] = list(dict_mean_test_corr.values())
df_temp['test_mean_incorrect'] = list(dict_mean_test_incorr.values())
#df_temp.to_csv('paper_tables/detailed_uncertainty_aleatoric.csv')
...
df_temp['fscore'] = list(fscore)
df_temp['support'] = list(support)
#df_temp.to_csv('paper_tables/bnn_results_method2.csv')
...
#df_plot.to_csv('Source_data/3C.csv',index=False)
